...
exports.ConceptIncrementalHiringDTO = void 0;
const swagger_1 = require("@nestjs/swagger");
class ConceptIncrementalHiringDTO {
}
__decorate([
...
], ConceptIncrementalHiringDTO.prototype, "onShoreCountY1", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'The number of incremental FTEs in Year 2', example: 2 }),
    __metadata("design:type", Number)
], ConceptIncrementalHiringDTO.prototype, "onShoreCountY2", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'The number of incremental FTEs in Year 3', example: 1 }),
    __metadata("design:type", Number)
], ConceptIncrementalHiringDTO.prototype, "onShoreCountY3", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'The number of incremental FTEs in Year 1', example: 3 }),
    __metadata("design:type", Number)
], ConceptIncrementalHiringDTO.prototype, "offShoreCountY1", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'The number of incremental FTEs in Year 2', example: 2 }),
    __metadata("design:type", Number)
], ConceptIncrementalHiringDTO.prototype, "offShoreCountY2", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'The number of incremental FTEs in Year 3', example: 1 }),
    __metadata("design:type", Number)
], ConceptIncrementalHiringDTO.prototype, "offShoreCountY3", void 0);
__decorate([
