...
], CreateCalculationPolicyReceiveDTO.prototype, "receiveAction", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({
        description: 'The Payroll Code id associated with this calculation policy receive',
    }),
    __metadata("design:type", String)
], CreateCalculationPolicyReceiveDTO.prototype, "payrollCodeId", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({
        default: calculation_1.ReceiveActionTypeENUM.CHANGETOPAYROLLCODE,
...
], CreateCalculationPolicyReceiveDTO.prototype, "amount", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({
...
], CreateCalculationPolicyReceiveDTO.prototype, "unit", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({
        description: 'The order of this receive (ex receive an extra 8 worked hours might cause an extra calculation)',
    }),
    __metadata("design:type", Number)
], CreateCalculationPolicyReceiveDTO.prototype, "order", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Effective date of this record' }),
    __metadata("design:type", String)
], CreateCalculationPolicyReceiveDTO.prototype, "effectiveDate", void 0);
exports.CreateCalculationPolicyReceiveDTO = CreateCalculationPolicyReceiveDTO;
//# sourceMappingURL=createCalculationPolicyReceive.dto.js.map